...
point_breakdown_checkpoint = [
    ...
    (7, ["channel_test_stress_send_recv"]),
    (7, ["sanitize_test_stress_send_recv"]),
    (7, ["valgrind_test_stress_send_recv"]),
...
point_breakdown_final = [
    ...
    (5, ["sanitize_test_channel_close_with_send"]),
    ...
    (2, ["sanitize_test_select_and_non_blocking_send_size1"]),
    (2, ["valgrind_test_select_and_non_blocking_send_size1"]),
    (2, ["channel_test_select_and_non_blocking_receive_size1"]),
    (2, ["sanitize_test_select_and_non_blocking_receive_size1"]),
    (2, ["valgrind_test_select_and_non_blocking_receive_size1"]),
    (2, ["channel_test_select_with_select_size1"]),
    (2, ["sanitize_test_select_with_select_size1"]),
    (2, ["valgrind_test_select_with_select_size1"]),
    (2, ["channel_test_select_with_same_channel_size1"]),
    (2, ["sanitize_test_select_with_same_channel_size1"]),
    (2, ["valgrind_test_select_with_same_channel_size1"]),
    (2, ["channel_test_select_with_send_receive_on_same_channel_size1"]),
    (2, ["sanitize_test_select_with_send_receive_on_same_channel_size1"]),
    (2, ["valgrind_test_select_with_send_receive_on_same_channel_size1"]),
    (2, ["channel_test_select_with_duplicate_channel_size1"]),
    (2, ["sanitize_test_select_with_duplicate_channel_size1"]),
    (2, ["valgrind_test_select_with_duplicate_channel_size1"]),
    (15, ["channel_test_stress"]),
    (15, ["sanitize_test_stress"]),
    (15, ["valgrind_test_stress"]),
    (2, ["channel_test_select_response_time"]),
    (2, ["sanitize_test_select_response_time"]),
    (2, ["valgrind_test_select_response_time"]),
    (2, ["channel_test_cpu_utilization_select"]),
    (2, ["sanitize_test_cpu_utilization_select"]),
    (2, ["valgrind_test_cpu_utilization_select"]),
    (2, ["channel_test_cpu_utilization_overall"]),
    (2, ["sanitize_test_cpu_utilization_overall"]),
    (2, ["valgrind_test_cpu_utilization_overall"]),
]
